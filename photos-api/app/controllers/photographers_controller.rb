class PhotographersController < ApplicationController
  ...
  def create
    ...
    if @photographer.save
      ...
      render json: @photographer.errors, status: :unprocessable_content
    end
  end
  ...
  private
    ...
    def set_photographer
      @photographer = Photographer.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def photographer_params
      params.expect(photographer: [ :photographer_id, :photographer, :photographer_url ])
    end
end
